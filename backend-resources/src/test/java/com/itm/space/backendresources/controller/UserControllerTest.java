...
@WithMockUser(username = "hovo", password = "moderator", authorities = "ROLE_MODERATOR")
public class UserControllerTest extends BaseIntegrationTest {
    ...
    void setUp() {
        ...
        userRequest = new UserRequest("poghos", "poghos@mail.ru", "124578", "Poghos", "Poghosyan");
    }
    ...
    void testHello() throws Exception {
        ...
        assertEquals("hovo", responseContent);
    }
    ...
    void getUserById() {
        try {
            ...
            assertEquals("vaxik", userResponse.getFirstName());
